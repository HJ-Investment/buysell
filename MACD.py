...
tf.app.flags.DEFINE_string('data_dir', '/tmp/xxx',
...
def inputs(eval_data):
  """Construct input for MACD evaluation using the Reader ops.
  ...
  data_dir = os.path.join(FLAGS.data_dir, 'xxx')
