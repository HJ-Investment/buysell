...
def plot_kdj(data):
    ...
    _kdj_data = kdj(data)
    plt.plot(_kdj_data["date"], _kdj_data["k"], label="K", color='gray')
    plt.plot(_kdj_data["date"], _kdj_data["d"], label="D", color='yellow')
    plt.plot(_kdj_data["date"], _kdj_data["j"], label="J", color='blue')
    plt.title("KDJ")
    plt.xlabel('date')
    plt.ylabel('value')
    plt.legend()
...
def plot_rsi(data):
    ...
    RSI12 = rsi(data, 12)
    RSI24 = rsi(data, 24)
    plt.plot(RSI6["date"], RSI6['rsi'], label="RSI(n=6)")
