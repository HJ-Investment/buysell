...
def load_emnist_image(path, imagefilename, labelfilename, type = 'train'):
...
#         print(label)
#         # print(img)
#         cv2.imwrite("/tmp/handwriting/datasets/rawdata/aa/train_{a}.png".format(a = i), img)